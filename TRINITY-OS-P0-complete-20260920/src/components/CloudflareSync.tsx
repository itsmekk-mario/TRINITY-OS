...
import { fetchCloudflareData, loadCloudflareConfig, loadRecoveryCopy, saveRecoveryCopy, uploadCloudflareData } from '../lib/cloudflare';
...
export default function CloudflareSync({ data, update, onLogout }: { data: AppData; update: (fn: (value: AppData) => AppData) => void; onLogout?: () => void }) {
  ...
  const download = async () => {
    ...
    try {
      ...
      saveRecoveryCopy(userId, data); update(() => remote.data as AppData);
