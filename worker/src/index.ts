...
export interface Env {
  ...
  AI_PROVIDER?: string; AI_TIMEOUT_MS?: string; AI_DEBUG?: string; ENVIRONMENT?: string;
...
const providerConfig = (env: Env): AIServiceConfig => ({ provider: env.AI_PROVIDER || 'nvidia-nim', apiKey: env.NVIDIA_API_KEY, model: env.NVIDIA_MODEL, baseUrl: env.NVIDIA_BASE_URL, timeoutMs: env.AI_TIMEOUT_MS, debug: env.AI_DEBUG, environment: env.ENVIRONMENT });
