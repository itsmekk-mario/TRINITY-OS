...
export default function TrinityAnalysis({data,update}:{data:AppData;update:(fn:(value:AppData)=>AppData)=>void}){
 ...
 return <div><PageHeader eyebrow="TRINITY ANALYSIS" title="학습 프레임워크" description="정답 여부를 넘어서, 기준이 실전에서 유지되고 자동 행동으로 나오는지 분석합니다."/>
