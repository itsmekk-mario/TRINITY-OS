...
import { Empty, PageHeader, RichMathText } from '../components/Ui';
...
function WrongAnswers({ data, edit, quick }: { data: AppData; edit: () => void; quick: () => void }) {
  ...
  return <div><PageHeader eyebrow="WRONG ANSWERS" title="오답을 행동으로 바꿉니다" description="저장한 판단·놓친 단서·교정 행동을 한 번 입력하고 재도전까지 이어갑니다." action={<button className="button primary" onClick={quick}>Quick Capture</button>} />
