...
export type Resource = { id: string; subject: Subject; group: string; name: string; total: number; done: number; dueDate?: string };
...
export type WrongAnswerDrill = { id: string; date: string; subject: Subject; source: string; question: string; wrongJudgment: string; missedCue: string; correction: string; transfer: string; scoreId?: string; capabilityGoalId?: string; archiveEntryId?: string; bottleneck?: DrillBottleneck; retries?: DrillRetry[] };
