...
const tabs=['Overview','Calendar','Capability','Bottlenecks','Mock Exams','Wrong Answers','Drill','Resources','Feedback'] as const;
type Tab=typeof tabs[number];
const tabLabels:Record<Tab,string>={Overview:'요약',Calendar:'일별 기록',Capability:'역량 현황',Bottlenecks:'반복 병목','Mock Exams':'모의고사','Wrong Answers':'오답 기록',Drill:'Drill',Resources:'학습 자료',Feedback:'피드백'};
const navGroups:{label:string;tabs:Tab[]}[]=[{label:'홈',tabs:['Overview','Calendar']},{label:'진단',tabs:['Capability','Bottlenecks']},{label:'학습 기록',tabs:['Mock Exams','Wrong Answers','Drill']},{label:'지도 자료',tabs:['Resources','Feedback']}];
