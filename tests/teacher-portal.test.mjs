...
function harness(){
 ...
 for(const name of ['0001_support_portal.sql','0002_feedback_collaboration.sql','0003_feedback_context.sql','0008_security_hardening.sql','0010_teacher_signals.sql'])db.exec(readFileSync(new URL('../worker/migrations/'+name,import.meta.url),'utf8'));
